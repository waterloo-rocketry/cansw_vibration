...
# 2 "<built-in>" 2
# 1 "rocketlib/pic18f26k83/i2c.c" 2
...
# 1 "rocketlib/pic18f26k83/../include/i2c.h" 1



# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\stdbool.h" 1 3
# 4 "rocketlib/pic18f26k83/../include/i2c.h" 2
...
# 3 "rocketlib/pic18f26k83/i2c.c" 2
...
_Bool i2c_read_reg8(uint8_t address, uint8_t reg, uint8_t *value) {
    _Bool success = i2c_write(address, &reg, 1);
    if (!success) {
        return 0;
    }
