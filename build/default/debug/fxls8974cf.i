...
void fxls_init(void) {
    ...
    i2c_write_reg8(0x31, 0x16, sens_config2);
    ...
    i2c_write_reg8(0x31, 0x26, buf_config1);


    uint8_t sens_config3 = 0b01011111;


    i2c_write_reg8(0x31, 0x17, sens_config3);


    uint8_t int_en = 0b10000000;
# 44 "fxls8974cf.c"
    i2c_write_reg8(0x31, 0x20, int_en);


    uint8_t int_pin_sel = 0b00000000;
# 56 "fxls8974cf.c"
    i2c_write_reg8(0x31, 0x21, int_pin_sel);



    uint8_t sens_config4 = 0b00000001;
# 69 "fxls8974cf.c"
    i2c_write_reg8(0x31, 0x18, sens_config4);
    ...
    i2c_write_reg8(0x31, 0x15, sens_config1);
}

uint8_t fxls_get_prod_rev(void) {
    uint8_t res;
    i2c_read_reg8(0x31, 0x12, &res);
    return res;
}

uint8_t fxls_get_whoami(void) {
    uint8_t res;
    i2c_read_reg8(0x31, 0x13, &res);
    return res;
}
...
# 121 "fxls8974cf.c"
    i2c_read_reg8(0x31, 0x04, &x_lsb);
    i2c_read_reg8(0x31, 0x05, &x_msb);
    i2c_read_reg8(0x31, 0x06, &y_lsb);
    i2c_read_reg8(0x31, 0x07, &y_msb);
    i2c_read_reg8(0x31, 0x08, &z_lsb);
    i2c_read_reg8(0x31, 0x09, &z_msb);
